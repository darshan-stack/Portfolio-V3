    ...
    <>
      ...
      >
        {certificates.map((cert) => (
          <Card
            key={cert.file}
            className="group h-full w-full cursor-pointer overflow-hidden rounded-xl border border-zinc-800/50 bg-zinc-900/40 backdrop-blur-md p-0 shadow-none transition-all hover:bg-zinc-900/60"
