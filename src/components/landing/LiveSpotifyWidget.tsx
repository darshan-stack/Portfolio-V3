...
export default function LiveSpotifyWidget() {
    const { track, isPlaying, loading } = useSpotify();

    // Fallback when not playing
    const fallbackTrack = {
        title: 'Not Playing',
        artist: 'Connect Spotify to Discord to see live activity',
        album: 'Spotify',
        albumArt: '',
        url: '#',
    };
    ...
    return (
        <section className="py-8 relative">
            <div id="live-spotify-widget" className="relative">
                <a
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className="text-[10px] text-green-500 font-medium">
                                    {isPlaying ? 'Now Playing (Live)' : 'Spotify'}
                                </span>
                            </div>
