        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col flex-wrap gap-4">
              {devices.map((device) => (
                <div key={device.name} className="flex items-center gap-4 rounded-xl border border-zinc-800/50 bg-zinc-900/40 backdrop-blur-md p-4 transition-all hover:bg-zinc-900/60">
                  <div className="bg-zinc-800/50 backdrop-blur-sm flex items-center justify-center rounded-md border border-zinc-700/50 p-2 text-[#736F70]">
                    {device.icon}
                  </div>
          ...
          <div className="space-y-4 pt-10">
            ...
            <div className="mt-8 flex flex-col flex-wrap gap-4">
              {webExtensions.map((extension, index) => (
                <div key={extension.name} className="flex items-center gap-4 rounded-xl border border-zinc-800/50 bg-zinc-900/40 backdrop-blur-md p-4 transition-all hover:bg-zinc-900/60">
                  <div className="flex items-center gap-2">
                    <div className="bg-zinc-800/50 backdrop-blur-sm flex items-center justify-center rounded-md border border-zinc-700/50 px-2 py-1 text-[#736F70]">
          ...
          <div className="space-y-4 pt-10">
            ...
            <div className="mt-8 flex flex-col flex-wrap gap-4">
              {software.map((app, index) => (
                <div key={app.name} className="flex items-center gap-4 rounded-xl border border-zinc-800/50 bg-zinc-900/40 backdrop-blur-md p-4 transition-all hover:bg-zinc-900/60">
                  <div className="flex items-center gap-2">
                    <div className="bg-zinc-800/50 backdrop-blur-sm flex items-center justify-center rounded-md border border-zinc-700/50 px-2 py-1 text-[#736F70]">
